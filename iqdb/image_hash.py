# THIS IS FILE IS A COPY FROM https://github.com/rr-/szurubooru/blob/master/server/szurubooru/func/image_hash.py
...
def _preprocess_image(content: bytes) -> NpMatrix:
    try:
        ...
        # raise(
        print("Unable to generate a signature hash " "for this image.")
        # )
